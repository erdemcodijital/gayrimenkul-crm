        ...
        <button
          ...
          className={`h-16 border border-gray-200 rounded-lg flex items-center justify-center text-sm font-medium transition ${
            isSelected
              ...
              : isAvailable && !isPast
              ? 'hover:bg-primary-50 hover:border-primary-300 text-gray-900'
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-8">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-6 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                {selectedDate && selectedTime && (
                  <div className="mt-4 p-4 bg-primary-50 rounded-lg">
                    <p className="text-sm font-medium text-primary-900 mb-2">Seçiminiz:</p>
